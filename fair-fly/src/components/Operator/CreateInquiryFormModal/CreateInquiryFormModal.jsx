...
export default function CreateInquiryFormModal({ onClose }) {
  ...
  return (
    <div className="cif-overlay" onClick={onClose}>
      <div className="cif-modal" onClick={(e) => e.stopPropagation()}>

        {/* Fixed header */}
        <div className="cif-header">
          <div>
            <h2>Create New Inquiry Form</h2>
            <p>Fill out the form details for client inquiry documentation</p>
          </div>
          <button className="cif-close" onClick={onClose}>
